    ...
    <main className="flex-1 overflow-x-auto">
      <div className="flex h-full gap-4 p-4 min-w-max">
        ...
        <button
          onClick={addPanel}
          style={{ width: '400px' }}
          className="shrink-0 rounded-lg border border-dashed border-gray-700 bg-gray-900/50 p-4 flex items-center justify-center text-gray-500 hover:text-gray-300 hover:border-gray-500 transition-colors"
        >
          <svg
